...
def update_ipad_benchmarks_final():
    """使用完整映射更新所有iPad产品的跑分数据"""
    ...
    json_to_csv_mapping = {
        ...
        "iPad Pro 12.9 英寸(第 6 代)": "iPad Pro (12.9-inch, 6th generation)",
        "iPad Pro 11 英寸(M2)": "iPad Pro (11-inch, 4th generation)",
        "iPad Pro 11 英寸(第 4 代)": "iPad Pro (11-inch, 4th generation)",
        "iPad Pro 12.9 英寸(M1)": "iPad Pro (12.9-inch 5th generation)",
        "iPad Pro 12.9 英寸(第 5 代)": "iPad Pro (12.9-inch 5th generation)",
        "iPad Pro 11 英寸(M1)": "iPad Pro (11-inch 3rd generation)",
        "iPad Pro 11 英寸(第 3 代)": "iPad Pro (11-inch 3rd generation)",
        "iPad Pro 12.9 英寸(A12Z)": "iPad Pro 12.9-inch (4th generation)",
        "iPad Pro 12.9 英寸(第 4 代)": "iPad Pro 12.9-inch (4th generation)",
        "iPad Pro 11 英寸(A12Z)": "iPad Pro 11-inch (2nd generation)",
        "iPad Pro 11 英寸(第 2 代)": "iPad Pro 11-inch (2nd generation)",
        "iPad Pro 12.9 英寸(A12X)": "iPad Pro (12.9-inch 3rd Generation)",
        "iPad Pro 12.9 英寸(第 3 代)": "iPad Pro (12.9-inch 3rd Generation)",
        "iPad Pro 11 英寸(A12X)": "iPad Pro (11-inch)",
        "iPad Pro 11 英寸(第 1 代)": "iPad Pro (11-inch)",
        ...
        "iPad Pro 12.9 英寸(第 2 代)": "iPad Pro (12.9-inch 2nd Generation)",
        ...
        "iPad Air(第 5 代)": "iPad Air (5th generation)",
        "iPad Air(A14)": "iPad Air (4th generation)",
        "iPad Air(第 4 代)": "iPad Air (4th generation)",
    ...
    for ipad in ipad_data:
        ...
        if ipad_name in json_to_csv_mapping:
            ...
            # 检查是否需要使用默认映射
            if csv_model in default_mappings:
                default_data = default_mappings[csv_model]
                
                if "singleCore" in default_data:
                    ipad['benchmarks']['singleCore'] = default_data['singleCore']
                    benchmark_updated = True
                
                if "multiCore" in default_data:
                    ipad['benchmarks']['multiCore'] = default_data['multiCore']
                    benchmark_updated = True
                
                if "gpu" in default_data:
                    ipad['benchmarks']['gpu'] = default_data['gpu']
                    benchmark_updated = True
                
                if benchmark_updated:
                    updated_count += 1
                    print(f"已更新 {ipad_name} 的基准测试分数 (使用默认数据):")
                    if "singleCore" in default_data:
                        print(f"  - 单核: {default_data['singleCore']}")
                    if "multiCore" in default_data:
                        print(f"  - 多核: {default_data['multiCore']}")
                    if "gpu" in default_data:
                        print(f"  - GPU: {default_data['gpu']}")
            else:
                # 从CSV数据中更新
...
if __name__ == "__main__":
    print("开始使用完整映射更新所有iPad产品的跑分数据...\n")
    update_ipad_benchmarks_final()
    print("\n处理完成!")
