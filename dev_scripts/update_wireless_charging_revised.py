...
# 更新无线充电参数，将"MagSafe无线充电"改为"MagSafe+Qi"
updated_count = 0
for phone in iphone_data:
    if 'wireless' in phone and phone['wireless']:
        if 'MagSafe无线充电' in phone['wireless'] and 'Qi' not in phone['wireless']:
...
print(f'更新完成! 已将 {updated_count} 个iPhone型号的无线充电参数从"MagSafe无线充电"改为"MagSafe+Qi"')
